...
from src.models.components import PointWiseFeedForward
...
class GRU4RecBackbone(nn.Module):
    """
    GRU-based backbone for GRU4Rec. Uses recurrent neural network for sequential modeling.
    """
...
class SASRecBackbone(nn.Module):
    """
    Transformer-based backbone for SASRec. Uses self-attention with causal masking for sequential modeling.
    """
...
class BertBackbone(nn.Module):
    """
    Transformer-based backbone for Bert4Rec. Similar to SASRecBackbone but used in bidirectional context.
    """
...
class SASRec(BaseSeqModel):
    """SASRec: Self-Attentive Sequential Recommendation with sequence-to-sequence training objective"""
